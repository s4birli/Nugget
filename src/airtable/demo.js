...
export const getEmployees = async () => {
  const url = `https://api.airtable.com/v0/appfdyVLRFJ1TwXmt/Employees?maxRecords=${MAX_RECORD}&view=Grid%20view`;
...
export const getCandidates = async () => {
  const url = `https://api.airtable.com/v0/appfdyVLRFJ1TwXmt/Candidates?maxRecords=${MAX_RECORD}&view=Grid%20view`;
  const results = await getDataFromAirtable(url);
...
export const getSkills = async () => {
  const url = `https://api.airtable.com/v0/appfdyVLRFJ1TwXmt/General?maxRecords=${MAX_RECORD}&view=Grid%20view`;
  const results = await getDataFromAirtable(url);
...
export const getHighlights = async () => {
  const url = `https://api.airtable.com/v0/appfdyVLRFJ1TwXmt/Highlights?maxRecords=${MAX_RECORD}&view=Grid%20view`;
  const results = await getDataFromAirtable(url);
...
export const getDataVis = async () => {
  const url = `https://api.airtable.com/v0/appfdyVLRFJ1TwXmt/DataVis?maxRecords=${MAX_RECORD}&view=Grid%20view`;
  const results = await getDataFromAirtable(url);
