...
class S3FileUpload {
  ...
  static async uploadFileWithName(file, config, fileName) {
    // Error Thrower :x:
    throwError(config, file);
...
const { uploadFile, deleteFile, uploadFileWithName } = S3FileUpload;
export { uploadFile, deleteFile, uploadFileWithName };
